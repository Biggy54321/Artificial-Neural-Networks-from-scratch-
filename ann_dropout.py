...
class ANN:
    ...
    def back_prop(self, delta, wt_sum, act, drop_mat, batch_size):
        """
        Description -
    ...
    def train(self, x, y, learn_rate, epochs, batch_size, keep_prob):
        """ 
        Description -
        ...
        for e in range(epochs):
            ...
            for b in range(0, len(x), batch_size):
                ...
                dw, db = self.back_prop(delta, wt_sum, act, drop_mat, batch_size)
